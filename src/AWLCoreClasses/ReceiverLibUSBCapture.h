...
/** \brief TheReceiverCANCapture class is a specialized implementation of the ReceiverCapture
  ...
  */
class ReceiverLibUSBCapture: public ReceiverCANCapture
{
// Public types
public:
	typedef boost::shared_ptr<ReceiverLibUSBCapture> Ptr;
    typedef boost::shared_ptr<ReceiverLibUSBCapture> ConstPtr;

// public Methods
public:
	/** \brief ReceiverLibUSBCapture constructor.
	...
	ReceiverLibUSBCapture(int receiverID, int inReceiverChannelQty, int inReceiverColumns, int inReceiverRows, float inLineWrapAround, 
		               eReceiverCANRate inCANBitRate,
	...
	/** \brief ReceiverLibUSBCapture constructor from a configuration file information.
 	    * \param[in] inReceiverID  unique receiverID
