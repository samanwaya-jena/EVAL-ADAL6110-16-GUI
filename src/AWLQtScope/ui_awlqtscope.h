...
public:
    ...
    QGroupBox *scopeDisplayGroupBox;
    QCheckBox *scopeDisplayDistanceCheckBox;
    QCheckBox *scopeDisplayVelocityCheckBox;
    QFrame *distanceLine;
    QFrame *velocityLine;
    ...
    void setupUi(QWidget *AWLQtScopeClass)
    {
        ...
        AWLQtScopeClass->setMinimumSize(QSize(0, 0));
        QPalette palette;
        ...
        QFont font;
        channel5PlotFrame->setFont(font);
        channel5PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        ...
        channel3PlotFrame->setFont(font);
        channel3PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        channel3PlotFrame->setFrameShape(QFrame::NoFrame);
        ...
        channel4PlotFrame->setFont(font);
        channel4PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        ...
        channel6PlotFrame->setFont(font);
        channel6PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        ...
        channel7PlotFrame->setFont(font);
        channel7PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        ...
        channel1PlotFrame->setFont(font);
        channel1PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        ...
        channel2PlotFrame->setFont(font);
        channel2PlotFrame->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"font-size: 9px;\n"
"}"));
        ...
        scopeCurveStyleGroupBox->setGeometry(QRect(1080, 250, 161, 71));
...
""));
        ...
        scopeDisplayGroupBox = new QGroupBox(AWLQtScopeClass);
        scopeDisplayGroupBox->setObjectName(QStringLiteral("scopeDisplayGroupBox"));
        scopeDisplayGroupBox->setGeometry(QRect(1080, 160, 161, 80));
        sizePolicy1.setHeightForWidth(scopeDisplayGroupBox->sizePolicy().hasHeightForWidth());
        scopeDisplayGroupBox->setSizePolicy(sizePolicy1);
        scopeDisplayGroupBox->setMinimumSize(QSize(161, 80));
        scopeDisplayGroupBox->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
"border: 1px solid black;\n"
"background-color: #ffa02f;\n"
"padding: 1px;\n"
...
"}\n"
""));
        scopeDisplayDistanceCheckBox = new QCheckBox(scopeDisplayGroupBox);
        scopeDisplayDistanceCheckBox->setObjectName(QStringLiteral("scopeDisplayDistanceCheckBox"));
        scopeDisplayDistanceCheckBox->setGeometry(QRect(20, 20, 91, 17));
        scopeDisplayDistanceCheckBox->setChecked(true);
        scopeDisplayDistanceCheckBox->setTristate(false);
        scopeDisplayVelocityCheckBox = new QCheckBox(scopeDisplayGroupBox);
        scopeDisplayVelocityCheckBox->setObjectName(QStringLiteral("scopeDisplayVelocityCheckBox"));
        scopeDisplayVelocityCheckBox->setGeometry(QRect(20, 40, 91, 17));
        distanceLine = new QFrame(scopeDisplayGroupBox);
        distanceLine->setObjectName(QStringLiteral("distanceLine"));
        distanceLine->setGeometry(QRect(110, 26, 31, 10));
        QPalette palette1;
        ...
        distanceLine->setPalette(palette1);
        distanceLine->setLayoutDirection(Qt::LeftToRight);
        distanceLine->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"color: #ffaa00;\n"
"}\n"
""));
        distanceLine->setFrameShadow(QFrame::Plain);
        distanceLine->setLineWidth(2);
        distanceLine->setFrameShape(QFrame::HLine);
        velocityLine = new QFrame(scopeDisplayGroupBox);
        velocityLine->setObjectName(QStringLiteral("velocityLine"));
        velocityLine->setGeometry(QRect(110, 45, 31, 10));
        QPalette palette2;
        ...
        velocityLine->setPalette(palette2);
        velocityLine->setLayoutDirection(Qt::LeftToRight);
        velocityLine->setStyleSheet(QLatin1String("QWidget\n"
"{\n"
"color: #FF00FF;\n"
"}\n"
""));
        velocityLine->setFrameShadow(QFrame::Plain);
        velocityLine->setLineWidth(2);
        velocityLine->setFrameShape(QFrame::HLine);
        ...
        QObject::connect(scopeDisplayDistanceCheckBox, SIGNAL(toggled(bool)), AWLQtScopeClass, SLOT(on_scopeDisplayDistance_toggled(bool)));
        QObject::connect(scopeDisplayVelocityCheckBox, SIGNAL(toggled(bool)), AWLQtScopeClass, SLOT(on_scopeDisplayVelocity_toggled(bool)));
    ...
    {
        AWLQtScopeClass->setWindowTitle(QApplication::translate("AWLQtScopeClass", "AWLQtScope", Q_NULLPTR));
        scopeCurveStyleGroupBox->setTitle(QApplication::translate("AWLQtScopeClass", "Curve Style", Q_NULLPTR));
        scopeCurveStyleDotsRadioButton->setText(QApplication::translate("AWLQtScopeClass", "Dots", Q_NULLPTR));
        scopeCurveStyleLinesRadioButton->setText(QApplication::translate("AWLQtScopeClass", "Lines", Q_NULLPTR));
        scopeDisplayGroupBox->setTitle(QApplication::translate("AWLQtScopeClass", "Display", Q_NULLPTR));
        scopeDisplayDistanceCheckBox->setText(QApplication::translate("AWLQtScopeClass", "Distance (m)", Q_NULLPTR));
        scopeDisplayVelocityCheckBox->setText(QApplication::translate("AWLQtScopeClass", "Velocity", Q_NULLPTR));
    } // retranslateUi
