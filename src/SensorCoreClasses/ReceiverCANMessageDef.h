...
#define RECEIVERCANMSG_ID_CMD_RESPONSE_NACK            0xC3
#define RECEIVERCANMSG_ID_CMD_RESPONSE_ACK_SET         0xC8
#define RECEIVERCANMSG_ID_CMD_RESPONSE_ACK_GET         0xC9
#define RECEIVERCANMSG_ID_CMD_RESPONSE_QUEUE_EMPTY     0xCA
