...
void AWLQtDemo::on_viewAboutActionTriggered()
{
	...
	msgBox.setText("QtDemo 1.4.0<br><br>Copyright &copy; 2018 Phantom Intelligence inc.<br><br><a href='http://phantomintelligence.com'>http://phantomintelligence.com</a>");
	msgBox.exec();
}
