...
""));
    ...
    void retranslateUi(QWidget *AWLQtScopeClass)
    {
        ...
        scopeDisplayGroupBox->setTitle(QApplication::translate("AWLQtScopeClass", "Display", 0));
        scopeDisplayDistanceCheckBox->setText(QApplication::translate("AWLQtScopeClass", "Distance (m)", 0));
        scopeDisplayVelocityCheckBox->setText(QApplication::translate("AWLQtScopeClass", "Velocity", 0));
    } // retranslateUi
