/* AWLCANMessageDef.h : Defines tha basic CAN message structure for Phantom Intelligence sensors */
/*
...
#define AWLCANMSG_ID_CMD_SET_PARAMETER            0xC0
#define AWLCANMSG_ID_CMD_QUERY_PARAMETER          0xC1
#define AWLCANMSG_ID_CMD_RESPONSE_PARAMETER       0xC2
#define AWLCANMSG_ID_CMD_PLAYBACK_RAW             0xD1
#define AWLCANMSG_ID_CMD_RECORD_CALIBRATION       0xDA
#define AWLCANMSG_ID_CMD_TRANSMIT_RAW             0xE0
#define AWLCANMSG_ID_CMD_TRANSMIT_COOKED          0xE1

#define AWLCANMSG_ID_CMD_PARAM_ALGO_SELECTED      0x01
#define AWLCANMSG_ID_CMD_PARAM_ALGO_PARAMETER     0x02
#define AWLCANMSG_ID_CMD_PARAM_AWL_REGISTER       0x03
#define AWLCANMSG_ID_CMD_PARAM_BIAS               0x04
#define AWLCANMSG_ID_CMD_PARAM_ADC_REGISTER       0x05
#define AWLCANMSG_ID_CMD_PARAM_PRESET             0x06
#define AWLCANMSG_ID_CMD_PARAM_GLOBAL_PARAMETER   0x07
#define AWLCANMSG_ID_CMD_PARAM_GPIO_CONTROL       0x08
#define AWLCANMSG_ID_CMD_PARAM_TRACKER_SELECTED   0x11
#define AWLCANMSG_ID_CMD_PARAM_TRACKER_PARAMETER  0x12
#define AWLCANMSG_ID_CMD_PARAM_DATE_TIME          0x20
#define AWLCANMSG_ID_CMD_PARAM_RECORD_FILENAME    0xD0
#define AWLCANMSG_ID_CMD_PARAM_PLAYBACK_FILENAME  0xD1

#define AWLCANMSG_ID_CMD_PARAM_SENSOR_SPECIFIC    0x24
#define AWLCANMSG_ID_CMD_SSP_ENABLE_SYSTEM	  0x10
#define AWLCANMSG_ID_CMD_SSP_FRAME_RATE		  0x11
#define AWLCANMSG_ID_CMD_SSP_ENABLE_LASER	  0x31
#define AWLCANMSG_ID_CMD_SSP_ENABLE_AUTO_GAIN	  0x32
#define AWLCANMSG_ID_CMD_SSP_ENABLE_DC_BALANCE	  0x33

#define AWLCANMSG_ID_CMD_PARAM_
